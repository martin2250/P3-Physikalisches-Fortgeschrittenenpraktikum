...
plt.plot(linB1, slope1*linB1 + intercept1, label='fit: $f(B)=a\\cdot B + b$')
...
plt.plot(linB2, slope2*linB2 + intercept2, label='fit: $f(B)=a\\cdot B + b$')
plt.xlabel(r'$B$ in mT')
plt.ylabel(r'$f$ in MHz')
plt.legend()
plt.grid()
...
plt.plot(linB3, slope3*linB3 + intercept3, label='fit: $f(B)=a\\cdot B + b$')
plt.xlabel(r'$B$ in mT')
plt.ylabel(r'$f$ in MHz')
plt.legend()
plt.grid()

...
Instead, the amplitudes $A_{5/6}$ of the fifth and sixth thingmajig are measured using the camera system.
The fifth thingmajig has mass $M$, the sixth has mass $m$.
...
The most prominent of which is that pnly the mean mass of all thingmajigs is given, so it is not possible to make assumptions regarding how much the individual thingmajigs vary from their mean value.
Also, in the calculation the springs are assumed to have no mass.
To make this assumption valid, the mass of the springs should be meausred to be negligibly small compared to the mass of the thingmajigs.

...
The experiment is performed using a russian spectroscope. \todo{That's racist.}
Incoming light is directed via mirrors to a diffraction grating.
More mirrors are used to direct the light from a certain angle of the diffraction grating onto a photomultiplier tube. \todo{onto/into?}
